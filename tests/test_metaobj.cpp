...
#undef NWIDGET_METAOBJECTS_QOBJECT_H
#undef NWIDGET_METAOBJECTS_ACTION_H
#undef NWIDGET_METAOBJECTS_LAYOUT_H
#undef NWIDGET_METAOBJECTS_BOXLAYOUT_H
#undef NWIDGET_METAOBJECTS_FORMLAYOUT_H
#undef NWIDGET_METAOBJECTS_GRIDLAYOUT_H
#undef NWIDGET_METAOBJECTS_STACKEDLAYOUT_H
#undef NWIDGET_METAOBJECTS_WIDGET_H
#undef NWIDGET_METAOBJECTS_ABSTRACTBUTTON_H
#undef NWIDGET_METAOBJECTS_DIALOGBUTTONBOX_H
#undef NWIDGET_METAOBJECTS_CHECKBOX_H
#undef NWIDGET_METAOBJECTS_PUSHBUTTON_H
#undef NWIDGET_METAOBJECTS_COMMANDLINKBUTTON_H
#undef NWIDGET_METAOBJECTS_RADIOBUTTON_H
#undef NWIDGET_METAOBJECTS_TOOLBUTTON_H
#undef NWIDGET_METAOBJECTS_FRAME_H
#undef NWIDGET_METAOBJECTS_ABSTRACTSCROLLAREA_H
#undef NWIDGET_METAOBJECTS_ABSTRACTITEMVIEW_H
#undef NWIDGET_METAOBJECTS_HEADERVIEW_H
#undef NWIDGET_METAOBJECTS_LISTVIEW_H
#undef NWIDGET_METAOBJECTS_LISTWIDGET_H
#undef NWIDGET_METAOBJECTS_TABLEVIEW_H
#undef NWIDGET_METAOBJECTS_TABLEWIDGET_H
#undef NWIDGET_METAOBJECTS_TREEVIEW_H
#undef NWIDGET_METAOBJECTS_TREEWIDGET_H
#undef NWIDGET_METAOBJECTS_PLAINTEXTEDIT_H
#undef NWIDGET_METAOBJECTS_TEXTEDIT_H
#undef NWIDGET_METAOBJECTS_TEXTBROWSER_H
#undef NWIDGET_METAOBJECTS_TOOLBOX_H
#undef NWIDGET_METAOBJECTS_SPLITTER_H
#undef NWIDGET_METAOBJECTS_ABSTRACTSLIDER_H
#undef NWIDGET_METAOBJECTS_DIAL_H
#undef NWIDGET_METAOBJECTS_SLIDER_H
#undef NWIDGET_METAOBJECTS_SCROLLBAR_H
#undef NWIDGET_METAOBJECTS_ABSTRACTSPINBOX_H
#undef NWIDGET_METAOBJECTS_DATETIMEEDIT_H
#undef NWIDGET_METAOBJECTS_SPINBOX_H
#undef NWIDGET_METAOBJECTS_COMBOBOX_H
#undef NWIDGET_METAOBJECTS_GROUPBOX_H
#undef NWIDGET_METAOBJECTS_LABEL_H
#undef NWIDGET_METAOBJECTS_LINEEDIT_H
#undef NWIDGET_METAOBJECTS_MENU_H
#undef NWIDGET_METAOBJECTS_MENUBAR_H
#undef NWIDGET_METAOBJECTS_PROGRESSBAR_H
#undef NWIDGET_METAOBJECTS_TABBAR_H
#undef NWIDGET_METAOBJECTS_TABWIDGET_H
